    ...
    messages: [
      {
        ...
        content: [
          ...
          "결과는 1~2문장으로 짧게 출력해.",
          "설명, 따옴표, 변환 이유, 부가 안내 없이 변환된 댓글만 출력해.",
          "예시 입력: 멍멍텅구리야 너는 이게 문제야. 그걸 왜 그렇게 생각하냐?",
          "예시 출력: 멍멍텅구리님, 저는 조금 다르게 느꼈어요. 어떤 점에서 그렇게 생각했는지 더 들어보고 싶어요.",
          "예시 입력: 아니 그건 말이 안 되잖아. 제대로 생각한 거 맞아?",
          "예시 출력: 저는 그 부분이 조금 다르게 느껴졌어요. 어떤 기준으로 생각했는지 함께 이야기해 보면 좋겠어요.",
          "예시 입력: 너 진짜 답답하다. 왜 일을 그렇게 처리해?",
          "예시 출력: 그 상황이 조금 아쉽게 느껴졌어요. 다음에는 어떻게 하면 더 편하게 진행할 수 있을지 같이 이야기해 보면 좋겠어요.",
          extraInstruction
        ].filter(Boolean).join(" ")
      },
      {
